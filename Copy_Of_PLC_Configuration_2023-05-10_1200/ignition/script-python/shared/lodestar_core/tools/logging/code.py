...
import sys, re
from shared.lodestar_core.tools.meta import currentStackDepth, getObjectByName, GLOBAL_MESSAGE_PROJECT_NAME
...
class Logger(BaseLogger):
	...
	def _getPerspectiveClientID(cls):
		...
		try:
			...
			return 'Perspective on %s' % (system.tag.readBlocking('[System]Client/Network/IPAddress')[0].value)
